...
#define PAGEROUNDUP(p)  ((p + PAGE_SIZE - 1) & ~(PAGE_SIZE - 1))
...
/* attr */
#define AI_DEVICE_nGnRnE  0x0   /* 0b00000000: Device-nGnRnE memory */
#define AI_NORMAL_NC      0x44  /* 0b01000100: Normal memory, Outer Non-cacheable, Inner Non-cacheable */
